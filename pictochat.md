...
- I recommend not removing meshes, but instead either grey them out (use an HSV of 0,0,0.25 for vertex colors) and put them somewhat behind the stage (z of -35) to still show that a current scene is active
...
|9 | ![Cloud](https://ssb.wiki.gallery/images/thumb/6/69/PictoChat_2_Clouds.jpeg/175px-PictoChat_2_Clouds.jpeg)| `0x1880339f33-0x18c216984e` cloud speed. A=middle. B=bottom. C=top. | If we can move the cloud position that'd be nice |  <img src="assets/img/pictochat/cloud.png" alt="newcloud" width="175"/> |
...
|25 | ![Shooting Stars](https://ssb.wiki.gallery/images/thumb/2/27/PictoChat_2_Shooting_Star.jpeg/175px-PictoChat_2_Shooting_Star.jpeg)| `0x1518a1ffbc` star angle? | | | |
