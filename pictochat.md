...
|25 | ![Shooting Stars](https://ssb.wiki.gallery/images/thumb/2/27/PictoChat_2_Shooting_Star.jpeg/175px-PictoChat_2_Shooting_Star.jpeg)| Hardcoded collision (but WHY). Params start at `0x1a796fa1b0`? `0x1518a1ffbc` star angle. `0x253d141992` control when to split into two stars. | | | |
